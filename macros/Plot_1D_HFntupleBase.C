...
void Plot_1D_HFntupleBase(){
  HistPlot::SetStyle();

  int SKIP = 1; // how many events to skip, ex. 10 runs over 1/10 of events

  // g_PlotTitle = "Test Sample";
  // g_File.push_back("samples/HFntuple.root");
  // g_Tree.push_back("HFntupleNONE");
  // g_Scale.push_back(1.);

  g_PlotTitle = "QCD multi-jets";
  g_File.push_back("/Users/crogan/Dropbox/SAMPLES/SussexNt/QCD/Pythia8EvtGen_A14NNPDF23LO_jetjet_JZ2W.root");
  g_Tree.push_back("HFntupleNONE");
  g_File.push_back("/Users/crogan/Dropbox/SAMPLES/SussexNt/QCD/Pythia8EvtGen_A14NNPDF23LO_jetjet_JZ3W.root");
  g_Tree.push_back("HFntupleNONE");
  g_File.push_back("/Users/crogan/Dropbox/SAMPLES/SussexNt/QCD/Pythia8EvtGen_A14NNPDF23LO_jetjet_JZ4W.root");
  g_Tree.push_back("HFntupleNONE");
  g_File.push_back("/Users/crogan/Dropbox/SAMPLES/SussexNt/QCD/Pythia8EvtGen_A14NNPDF23LO_jetjet_JZ5W.root");
  g_Tree.push_back("HFntupleNONE");
  g_File.push_back("/Users/crogan/Dropbox/SAMPLES/SussexNt/QCD/Pythia8EvtGen_A14NNPDF23LO_jetjet_JZ6W.root");
  g_Tree.push_back("HFntupleNONE");
  g_File.push_back("/Users/crogan/Dropbox/SAMPLES/SussexNt/QCD/Pythia8EvtGen_A14NNPDF23LO_jetjet_JZ7W.root");
  g_Tree.push_back("HFntupleNONE");
  g_File.push_back("/Users/crogan/Dropbox/SAMPLES/SussexNt/QCD/Pythia8EvtGen_A14NNPDF23LO_jetjet_JZ8W.root");
  g_Tree.push_back("HFntupleNONE");
  g_File.push_back("/Users/crogan/Dropbox/SAMPLES/SussexNt/QCD/Pythia8EvtGen_A14NNPDF23LO_jetjet_JZ9W.root");
  g_Tree.push_back("HFntupleNONE");
  g_File.push_back("/Users/crogan/Dropbox/SAMPLES/SussexNt/QCD/Pythia8EvtGen_A14NNPDF23LO_jetjet_JZ10W.root");
  g_Tree.push_back("HFntupleNONE");
  g_File.push_back("/Users/crogan/Dropbox/SAMPLES/SussexNt/QCD/Pythia8EvtGen_A14NNPDF23LO_jetjet_JZ11W.root");
  g_Tree.push_back("HFntupleNONE");
  g_File.push_back("/Users/crogan/Dropbox/SAMPLES/SussexNt/QCD/Pythia8EvtGen_A14NNPDF23LO_jetjet_JZ12W.root");
  g_Tree.push_back("HFntupleNONE");
  ...
  for(int s = 0; s < Nsample; s++){
	...
	if(JETs_btag[i]){
      ...
      if(base->pileupweight <= 0.)
	base->pileupweight = 1.;
      double weight = base->pileupweight*base->XSecWeight*base->AnalysisWeight;
      hist->Fill(JETs[0].Pt(), weight);
    }
